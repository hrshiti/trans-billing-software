...
import { Wrench, User, MapPin, Phone, Loader2, CheckCircle2, ArrowRight, FileText, Image, Files, CreditCard, Building2, Check, Info, Files as FilesIcon } from 'lucide-react'
    ...
    <div className="animate-fadeIn" style={{ maxWidth: 640, margin: '0 auto', padding: '0 0 10px' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 16 }}>
        ...
        <p style={{ fontSize: '0.8rem', color: '#64748B', fontWeight: 500 }}>
           {step === 1 ? 'Enter your workshop information' : 'Upload required documents for verification'}
        </p>
      </div>
          ...
          <div className="animate-slideInRight">
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                 ...
                 <span style={{ fontSize: '0.8rem', fontWeight: 850, color: '#1E293B', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Workshop Identity</span>
              </div>
          ...
          <div className="animate-slideInRight">
            ...
            <div style={{ marginBottom: 16, padding: '16px 18px', background: '#F1F5F9', borderRadius: 18 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 12 }}>
                 <FilesIcon size={15} color="#7C3AED" />
